...
export default function ProductCart(props) {
	return (
		<div className="pt-2 md:pt-4">
			<div className="flex flex-col items-center justify-between mt-4 space-s-3 sm:space-s-4">
				<div className="mb-4">
					<Counter
				...
				<Button
					...
					variant="flat"
					className={`w-full h-11 md:h-12 px-1.5  mb-4${
				...
				<Button
					...
					variant="flat"
					className="w-full h-11 md:h-12 mt-4 "
				>
